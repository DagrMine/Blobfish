...
namespace Blobfish.Projectiles
{
	...
	public class CorruptFlames : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Corrupt Flamethrower Projectile"); // The English name of the projectile
		}
        ...
        {
			target.AddBuff(BuffID.CursedInferno, 60); //Gives cursed flames to target for 4 seconds. (60 = 1 second, 240 = 4 seconds)
        }
