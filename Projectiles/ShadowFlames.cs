...
namespace Blobfish.Projectiles
{
	...
	public class ShadowFlames : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Shadowflame Flamethrower Projectile"); // The English name of the projectile
		}
		...
		public override void AI()
		{
			...
			if (Main.rand.Next(2) == 0) {
				Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 27, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100); //JUST SO YOU KNOW, THAT NUMBER DETERMINES THE TYPE OF VANILLA DUST IT USES
        ...
        {
			target.AddBuff(BuffID.ShadowFlame, 240); //Gives cursed flames to target for 4 seconds. (60 = 1 second, 240 = 4 seconds)
        }
