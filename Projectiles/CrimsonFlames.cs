...
namespace Blobfish.Projectiles
{
	...
	public class CrimsonFlames : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Crimson Flamethrower Projectile"); // The English name of the projectile
		}
        ...
        {
			target.AddBuff(BuffID.Ichor, 80); //Gives cursed flames to target for 4 seconds. (60 = 1 second, 240 = 4 seconds)
        }

		public override void OnHitPlayer(Player target, int damage, bool crit)
		{
			target.AddBuff(BuffID.Ichor, 80, false);
		}
