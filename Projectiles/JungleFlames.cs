...
namespace Blobfish.Projectiles
{
	...
	public class JungleFlames : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Jungle Flamethrower Projectile"); // The English name of the projectile
		}
		...
		public override void AI()
		{
			...
			if (Main.rand.Next(2) == 0) {
				Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.t_Cactus, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100);
