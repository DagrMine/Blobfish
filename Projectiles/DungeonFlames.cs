...
namespace Blobfish.Projectiles
{
	...
	public class DungeonFlames : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Dungeon Flamethrower Projectile"); // The English name of the projectile
		}
		...
		public override void AI()
		{
			...
			if (Main.rand.Next(2) == 0) {
				Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.DungeonWater, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100);
        ...
        {
			target.AddBuff(BuffID.Silenced, 60); //Gives cursed flames to target for 4 seconds. (60 = 1 second, 240 = 4 seconds)
        }

		public override void OnHitPlayer(Player target, int damage, bool crit)
		{
			target.AddBuff(BuffID.Silenced, 60, false);
		}
